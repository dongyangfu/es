package com.es.framework.aspectj;
...
import com.es.common.enums.BusinessStatus;
import com.es.common.json.JSON;
...
public class LogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.es.common.annotation.Log)")
