...
public class SysIndexController extends BaseController {
    ...
    public String index(ModelMap mmap) {
        ...
        mmap.put("copyrightYear", ESConfig.getCopyrightYear());
        mmap.put("demoEnabled", ESConfig.isDemoEnabled());
    ...
    public String main(ModelMap mmap) {
        mmap.put("version", ESConfig.getVersion());
        return "main";
    }
